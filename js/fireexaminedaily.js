...
var threeList = [
    ...
    {'title':'泡沫灭火系统',inputValue:'z24',radioData:[{radioName:'x9',radioTitle: '6.系统每半年除储罐上泡沫混合液立管和液下喷射防火堤内泡沫管道及高倍数泡沫产生器进口端控制阀后的管道外，其余管道应全部清洗，清除锈渣',radioValue:'0'},{radioName:'x10',radioTitle: '7.系统每年应进行一次自动启动检查试验。低、中倍数泡沫灭火系统选择一最不利的防护区，高倍数泡沫灭火系统任选一防护区，使防护区内感烟、感温探测器分别发出模拟火灾信号，观察并记录泡沫灭火装置动作情况及相关设施的动作情况和控制室消防控制设备信号显示情况',radioValue:'0'},{radioName:'b11',radioTitle: '8.标准要求：当防护区内感烟火灾探测器发出火灾报警信号后，控制室消防控制设备应接收并发出声、光报警信号，显示火灾探测器部位',radioValue:'0'},{radioName:'d12',radioTitle: '9.当防护区内感温火灾探测器发出火灾报警信号后，控制室消防控制设备应接收并发出声、光报警信号，显示火灾探测器部位，防护区内声、光警报装置应报警，消防控制设备应发出启动消防水泵或固定式消防泵组，打开防护区电控阀门的指令，泡沫灭火装置自动启动喷射（喷射时间不应小于1分钟）',radioValue:'0'},{radioName:'f13',radioTitle: '10.防护区内在泡沫淹没深度以下的门、窗应自动关闭，在封闭空间设置的排气口应自动开启，相关的生产、照明电源应被切断',radioValue:'0'},{radioName:'g14',radioTitle: '11.各部位动作时间及动作状态应符合设计要求。控制室消防控制设备应有泡沫喷射及各部位动作状态的反馈信号显示',radioValue:'0'},{radioName:'x15',radioTitle: '12.系统每年应进行一次远程启动试验。在控制室消防控制设备上手动启动一防护区的泡沫灭火装置，观察泡沫灭火装置动作情况及相关设施动作情况和消防控制设备信号显示情况',radioValue:'0'},{radioName:'b16',radioTitle: '13.标准要求：在控制室消防控制设备上手动启动泡沫灭火装置，防护区内声、光警报装置应报警，泡沫灭火装置应启动喷射，同时防护区相关的门、窗应自动关闭，封闭空间的排气口应自动开启，相关部位的生产、照明电源应被切断',radioValue:'0'},{radioName:'k17',radioTitle: '14.控制室消防控制设备应有泡沫喷射及各部位动作信号显示',radioValue:'0'},{radioName:'x18',radioTitle: '15.系统每年应进行一次紧急按钮启动检查试验。手动启动一防护区外泡沫灭火装置的紧急启动按钮，观察泡沫灭火装置动作情况及相关设施动作情况和消防控制设备信号显示情况',radioValue:'0'},{radioName:'b19',radioTitle: '16.标准要求：手动启动防护区外的紧急启动按钮，防护区内声、光报警装置应报警，控制室消防控制设备应接收并发出声、光报警信号',radioValue:'0'},{radioName:'x20',radioTitle: '17.显示紧急启动按钮部位并发出启动消防水泵或固定消防泵组，打开防护区电控阀门的指令，泡沫灭火装置应启动喷射',radioValue:'0'},{radioName:'f21',radioTitle: '18.防护区相关的门、窗应自动关闭，封闭空间的排气口应自动开启',radioValue:'0'},{radioName:'x22',radioTitle: '19.相关部位的生产、照明电源应被切断，控制室消防控制设备应有泡沫喷射及各部位动作的反馈信号显示',radioValue:'0'},{radioName:'x23',radioTitle: '20.系统检查和试验完毕，应对泡沫液泵或泡沫混合液泵、泡沫液管道、泡沫混合液管道、泡沫管道、泡沫比例混合器（装置）、泡沫消火栓、管道过滤器或喷过泡沫的泡沫产生装置等用清水冲洗后防控，复原系统',radioValue:'0'}]},
...
$(function(){
    ...
    $.each(radioList,function(index,item){
        ...
        '</div>'+radioStr+
        '<div class="inputbox"> <span class="font14">责任人：</span><input  class="inputText font14 b1" onchange="changeValue('+item.inputValue+')" type="text" placeholder="责任人"/></div>'+
        '</div>';
    })
